...
weatherModule.service('weatherService', function($http) {
    var service = {
      ...
      getWeather: function(location, units) {
        ...
        $http.get('http://api.openweathermap.org/data/2.5/weather?q='+location+'&units='+units+'&cnt=5&APPID=8534411ff0c52cbbe3b38f358309eccb').success(function(data) {
            if (data) {
                if (data.main) {
      ...
      getForecast: function(location, units) {
        ...
        $http.get('http://api.openweathermap.org/data/2.5/forecast/daily?q='+location+'&units='+units+'&cnt=10&APPID=8534411ff0c52cbbe3b38f358309eccb').success(function(data) {
            if (data) {
